...
describe("organization api validation", () => {
	...
	test('GET_userOrganization should throw "Invalid Token"', async () => {
	...
	test('GET_userOrganization should throw "Invalid Authorization Type" for mismatched authorization types', async () => {
